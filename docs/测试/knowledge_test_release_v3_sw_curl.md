```shell
curl -X POST http://127.0.0.1:8084/aisearch/knowledge/v2/reset -H "Content-Type: application/json"
```
...
curl -X POST http://127.0.0.1:8084/aisearch/knowledge/build -H "Content-Type: application/json"
...
curl -X POST http://127.0.0.1:8084/aisearch/knowledge/v2/buildStatus -H "Content-Type: application/json"
...
### 5. 重置对话（调用该接口，将重置历史对话信息，后续的对话不携带历史对话信息）

```shell

curl -X GET "http://127.0.0.1:8084/aisearch/stream-graph-chat?id=guest&input=%E6%A0%B9%E6%8D%AE%E3%80%8A%E5%B0%B1%E4%B8%9A%E6%9C%8D%E5%8A%A1%E4%B8%8E%E5%B0%B1%E4%B8%9A%E7%AE%A1%E7%90%86%E8%A7%84%E5%AE%9A%E3%80%8B%EF%BC%8C%E7%94%A8%E4%BA%BA%E5%8D%95%E4%BD%8D%E6%8B%9B%E7%94%A8%E4%BA%BA%E5%91%98%E6%97%B6%E4%B8%8D%E5%BE%97%E6%9C%89%E5%93%AA%E4%BA%9B%E8%A1%8C%E4%B8%BA%EF%BC%9F&query=123" \
...
### ！！！
### 1. 将用户原始输入转换成url编码
python3 -c "import urllib.parse; print(urllib.parse.quote('职业中介机构可以从事哪些业务？'))"
### 2. 修改input参数为用户的原始输入(编码后的)
