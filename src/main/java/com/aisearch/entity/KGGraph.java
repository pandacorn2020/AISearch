...
import com.aisearch.llm.KgCommunityTask;
import com.aisearch.llm.KgEntityDupRemovalTask;
import com.aisearch.llm.KgRelationshipDupRemovalTask;
...
public class KGGraph {
    ...
    private Map<Long, KGSegment> segmentMap;
    ...
    public void addEntities(List<String[]> entities, String fileName) {
        for (String[] entity : entities) {
            ...
            KGEntity kgEntity = new KGEntity(name, type, description, fileName);
            addEntity(kgEntity);
        }
    }

    public void addRelationships(List<String[]> relationships, String fileName) {
        for (String[] relationship : relationships) {
            ...
            KGRelationship kgRelationship =
                    new KGRelationship(source, target, type, description, fileName);
